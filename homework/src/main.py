...
def main():
    ...
    args = parse_argument()  # Parsear los argumentos de la linea de comandos
    ...
    mlflow.set_experiment(
        "wine_quality_experiment"
    )  # acá se puede cambiar el nombre del experimento
